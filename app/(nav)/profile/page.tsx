  ...
  return (
    <>
      <Head>
        <title>
          {profile
            ? `${displayName}'s Profile - Antivity`
            : "Profile - Antivity"}
        </title>
        <meta
          property="og:title"
          content={profile ? `${displayName}'s Profile` : "Profile"}
        />
        <meta
          property="og:description"
          content={
            bio || "Check out this profile on Antivity - Walk with purpose"
          }
        />
        <meta property="og:image" content="/logo/antjvity-logo.webp" />
        ...
        />
        <meta name="twitter:image" content="/logo/antjvity-logo.webp" />
      </Head>
          ...
          <div className="px-4 py-6 pt-0 pl-6 pr-6">
                  ...
                  onClick={async () => {
                    try {
                      ...
                      const shareData = {
                        ...
                        text: `Check out ${displayName}'s profile on our app!`,
                        url: profileUrl,
                      };
                          ...
                          <div className="absolute inset-0 p-2">
                            ...
                            >
                              ...
                              <div className="absolute bottom-2 left-2 mb-1.5 ml-1.5">
                                ...
                                >
                                  {s.images.length + (s.selfieUrl ? 1 : 0)}{" "}
                                  photo
            ...
            <section className="mt-6 mb-12">
              ...
              <div className="flex justify-center gap-6 items-center">
                ...
                {Array.from({
                  length: Math.max(0, 3 - earnedBadges.length),
                }).map((_, index) => (
                  <div
