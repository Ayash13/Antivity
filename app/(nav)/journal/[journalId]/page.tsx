...
export default function JournalDetailPage() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.download = `${journal.storyTitle || "journal"}-${journal.createdAt.toISOString().split("T")[0]}.jpg`
      link.target = "_blank"
            ...
            <div className="max-w-xl mx-auto px-4 pt-4 pb-4">
              <div className="flex items-center justify-between gap-2">
                ...
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="h-10 w-10 rounded-xl bg-[rgba(255,204,25,1)] hover:bg-[#E9B800] text-white disabled:opacity-50 transition-colors duration-200"
        ...
        <div className="max-w-xl mx-auto px-4">
          {loading ? (
            ...
            <div className="mt-4 space-y-6">
              <div className="rounded-[3.5rem] overflow-hidden bg-gray-100">
