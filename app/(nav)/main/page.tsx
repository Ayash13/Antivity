...
function MissionCard({ mission, isActive, onStartClick, missions }: MissionCardProps) {
  return (
    <Card
      className={cn(
      ...
      <CardContent className="flex mt-8 w-full flex-col items-center text-center">
        ...
        <Button
          ...
          className={cn(
            ...
            isActive ? "bg-[rgba(108,211,255,1)] hover:bg-[#50B0FF]" : "bg-gray-400 cursor-not-allowed",
          )}
          style={{ boxShadow: isActive ? "0 5px 0 #50B0FF" : "0 5px 0 #9CA3AF" }}
        >
