    ...
    >
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Hero Text */}
          <h1 className="text-5xl md:text-6xl font-bold text-[#7D47B9] mb-6">
            Discover Your World
          </h1>

          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-2xl mx-auto leading-relaxed">
            Embark on exciting missions, capture memories, and share your
            adventures. Antivity transforms everyday moments into extraordinary
            journeys.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12 max-w-3xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-lg">
              ...
              <h3 className="text-lg font-bold text-[#7D47B9] mb-2">
                Daily Missions
              </h3>
              <p className="text-gray-600">
                Complete exciting challenges and explore new places every day
              </p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                Capture and organize your memories with our beautiful journal
              </p>
            </div>
